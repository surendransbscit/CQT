...
class Attendance(models.Model):
    ...
    QR_string = models.CharField(null=True,max_length=255)
    ...
    def __str__(self):
        return f"{self.user.email} - {self.QR_string} - Checked Out: {self.checked_out}" 
...
class Leave(models.Model):
    ...
    reason = models.TextField(max_length=255, null=True, blank=True)
    day_out = models.CharField(max_length=50, null=True, blank=True)
