...
urlpatterns = [
    ...
    path('api/attendance', CheckInOutView.as_view(), name='check-in-out'),
    path('api/checkin_view',CheckInView.as_view(),name='checkin_view'),
    path('api/checkin-history/<int:pk>', HistoryView.as_view(), name='user-checkin-history'),
    path('api/checkin/<int:pk>/today', CheckInView.as_view(), name='user-today-checkins'),
    path('api/leave/user/<int:user_id>/', UserLeaveListView.as_view(), name='user-leave-list'),
     
    path('api/workfromhome/checkin', WorkFromHomeCheckInView.as_view(), name='workfromhome-checkin'),
    path('api/workfromhome/checkout/<int:pk>', WorkFromHomeCheckOutView.as_view(), name='workfromhome-checkout'),
    path('api/leave/request', RequestLeaveView.as_view(), name='leave-request'),
    path('api/leave/cancel/<int:pk>', CancelLeaveView.as_view(), name='leave-cancel'),
    path('api/leave/list', ListLeaveView.as_view(), name='leave-list'),
    path('api/leave/user/<int:user_id>', UserLeaveListView.as_view(), name='user-leave-list'),
    ...
    path('api/leaves/approve/<int:pk>', AdminLeaveApprovalAPI.as_view(), name='admin_leave_approval_api'),
