...
urlpatterns = [
    ...
    path('checkin-history/<int:pk>', HistoryView.as_view(), name='user-checkin-history'),
    path('checkin/<int:pk>/today', CheckInView.as_view(), name='user-today-checkins'),
    ...
    # path('api/checkin/', CheckInCreateView.as_view(), name='CheckIn'),
